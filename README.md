# Cue Queue [![Build Status](https://travis-ci.com/HundredPercentCoverage/audio-cue-player.svg?branch=master)](https://travis-ci.com/HundredPercentCoverage/audio-cue-player)
